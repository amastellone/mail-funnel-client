...
RSpec.describe "hooks_constants/new", type: :view do
  before(:each) do
    assign(:hooks_constant, HooksConstant.new(
      :name => "MyString",
      :identifier => "MyString",
      :type => "",
      :hook_type => "MyString"
  ...
  it "renders new hooks_constant form" do
    render

    assert_select "form[action=?][method=?]", hooks_constants_path, "post" do
